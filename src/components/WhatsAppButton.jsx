...
export const WhatsAppButton = () => {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-5 right-4 sm:bottom-6 sm:right-6 z-40 bg-[#25D366] hover:bg-[#20ba5a] text-white w-11 h-11 sm:w-14 sm:h-14 rounded-full flex items-center justify-center shadow-[0_4px_16px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_20px_rgba(37,211,102,0.5)] transition-all hover:scale-110 active:scale-95 animate-bounce cursor-pointer"
