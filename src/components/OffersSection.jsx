...
export const OffersSection = () => {
  ...
  const handleWhatsAppInquiry = (offerTitle) => {
    const text = encodeURIComponent(`Hi PAKSHAL AGENCYS, I would like to inquire about your offer: "${offerTitle}".`);
    window.open(`https://wa.me/919247449522?text=${text}`, '_blank');
  };

  const handleWhatsAppQuote = () => {
    const text = encodeURIComponent(`Hi PAKSHAL AGENCYS, I am a Builder/Contractor and would like to request a bulk quote for a project.`);
    window.open(`https://wa.me/919247449522?text=${text}`, '_blank');
  };
